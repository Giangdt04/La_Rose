...
const AdminDashboard = () => {
    ...
    const occupancyRate = totalRooms > 0 ? ((offlineRooms / totalRooms) * 100).toFixed(0) : 0;
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <StatCard title="Phòng đã đặt" value={offlineRooms} icon="fa-calendar-check" color={{bg: 'bg-green-100', text: 'text-green-500'}} />
